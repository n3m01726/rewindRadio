      ...
      <div class="offcanvas-body">
        ...
        <nav>
          <ul style="list-style-type: none;">
            <li class="mb-1">
              <h2><a style="text-decoration:none;" href="dashboard.php">Tableau de bord</a></h2>
            </li>
            <li class="mb-1">
              <h2><a style="text-decoration:none;" href="post-add.php">Ajouter un article</a></h2>
            </li>
            <li class="mb-1">
              <h2><a style="text-decoration:none;" href="post-list.php">Liste des articles</a></h2>
            </li>
            <li class="mb-1">
              <h2><a style="text-decoration:none;" href="user-add.php">Ajouter un utilisateur</a></h2>
            </li>
          </ul>
        </nav>
