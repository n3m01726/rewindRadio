...
define('REQUESTS_SECTION','1'); // définie comme 1 si le site affiche une section "dédicaces", ou comme '' (vide) s'il n'en affiche pas.
define('PODCASTS_SECTION','1'); // définie comme 1 si le site affiche une section "podcasts", ou comme '' (vide) s'il n'en affiche pas.
...
define('FACEBOOK_ID',''); // l'ID de la page Facebook associée à l'application, défini comme '' (vide).
