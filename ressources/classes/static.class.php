...
public static function get_header() {
    ...
    StaticContent::get_twitter_og();
    StaticContent::get_icons();
...
public static function get_scriptfiles() {
    echo '
...
public static function noScriptInstalled() {  
    define('LANG', substr($_SERVER['HTTP_ACCEPT_LANGUAGE'], 0, 2));
        ...
        <img src="images/logo.png" width="150px" height="150px" alt="rewindRadio logo">
        </div>
        ...
        <a class="btn btn-dark" href="'.SITE_URL.'/setup/index.php?language=fr" class="card-link">'.$lang["startInstallation_fr"].'</a>
        <hr>
        <h5>'.$lang["noInstallScript_tt_en"].'</h5>
        <p>'.$lang["noInstallScript_txt_en"].'</p>
        <a class="btn btn-dark" href="'.SITE_URL.'/setup/index.php?language=en" class="card-link">'.$lang["startInstallation_en"].'</a>
