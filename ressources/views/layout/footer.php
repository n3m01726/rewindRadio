            ...
            <div class="col-lg-3">
                <nav>
                    <ul>
                        ...
                        <li class='nav-item' id="join_us"><a href="posts.php?id=8"><?= $lang['volunteering']; ?></a></li>
                        <li class='nav-item' id="privacy_policy"><a href='posts.php?id=5'><?= $lang['privacyPolicy']; ?></a></li>
                    </ul>
                </nav>
            </div>
            <?php if (FOOTER3) { ?>
