    ...
    while ($row = $result->fetch()) {
     ...
     <!-- Team item-->
      <div class="col-xl-3 col-sm-6 mb-5">
        ...
        <a href="profile.php?id=<?= $row['id']; ?>"><img src="uploads/profile/<?= $row['avatar']; ?>" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"></a>
          ...
          <ul class="social mb-0 list-inline mt-3">
            ...
            <li class="list-inline-item"><a href="https://linkedin.com/<?= $row['instagram']; ?>" class="social-link"><i class="bi bi-linkedin"></i></a></li>
          </ul>
        </div>
      </div>
      <!-- End-->
